...
class STM_LMS_Google_Classroom_Auditory
{
    ...
    function __construct()
    {
        ...
        add_filter('wpcfto_lms_field_google_classroom_auditory', function () {
    ...
    function boxes($data_boxes)
    {
        $data_boxes['stm_auditory_settings'] = array(
            ...
            'label' => esc_html__('Auditory list', 'masterstudy-lms-learning-management-system'),
        );
            ...
            'section_curriculum' => array(
                ...
                'fields' => array(
                    'emails' => array(
                        ...
                        'label' => esc_html__('Course students', 'masterstudy-lms-learning-management-system'),
                        'fields' => array(
                            array(
                                'type' => 'text',
                                'label' => esc_html__('Student e-mail', 'masterstudy-lms-learning-management-system'),
                            )
                        )
                    ),
                )
