    ...
    $(document).ready(function () {
        ...
        new Vue({
            ...
            methods: {
                ...
                importCourse: function (course) {
                    var vm = this;

                    vm.$set(course, 'loading', true);
                    var url = stm_lms_ajaxurl +
                        '?action=stm_lms_get_google_classroom_course&course_id=' + course.course_id + '&nonce=' + stm_lms_nonces['stm_lms_get_google_classroom_course'];
                ...
                publishCourse: function (course) {
                    var vm = this;

                    vm.$set(course, 'loading', true);

                    var url = stm_lms_ajaxurl +
                        '?action=stm_lms_get_google_classroom_publish_course' +
                        '&course_id=' + course.course_id +
                        '&nonce=' + stm_lms_nonces['stm_lms_get_google_classroom_publish_course'];
