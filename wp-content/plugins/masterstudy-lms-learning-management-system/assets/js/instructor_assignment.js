        ...
        new Vue({
            ...
            methods: {
                getAssignments() {
                    ...
                    var url = stm_lms_ajaxurl + '?action=stm_lms_get_user_assingments&nonce='
                        + stm_lms_nonces['stm_lms_get_user_assingments'] +
                        '&id=' + window['stm_lms_assignment']['assignment_id'] +
                        '&page=' + vm.page +
                        '&status=' + vm.sort;
