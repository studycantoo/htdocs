        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description"><?php _e( 'Please note that the recording feature is not available through web, it is only available if the host has joined the meeting via the Zoom App.', 'video-conferencing-with-zoom-api' ) ?></p>
